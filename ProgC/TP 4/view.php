...
<head>
    <title>L2S1 INF1 - UEO 31.1  TP - Algo &amp; Prog 3 [SEN 971]: TP4 : Fonctions</title>
    <link rel="icon" href="//ecursus.univ-antilles.fr/pluginfile.php/1/theme_adaptable/favicon/1575298209/favicon.ico" />

<meta name="apple-itunes-app" content="app-id=633359593, app-argument=https://ecursus.univ-antilles.fr/mod/resource/view.php?id=54829"/><link rel="manifest" href="https://ecursus.univ-antilles.fr/admin/tool/mobile/mobile.webmanifest.php" /><meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="moodle, L2S1 INF1 - UEO 31.1  TP - Algo &amp; Prog 3 [SEN 971]: TP4 : Fonctions" />
...
M.cfg = {"wwwroot":"https:\/\/ecursus.univ-antilles.fr","sesskey":"UtSQqGZnx5","themerev":"1575298209","slasharguments":1,"theme":"adaptable","iconsystemmodule":"core\/icon_system_fontawesome","jsrev":"1574866144","admin":"admin","svgicons":true,"usertimezone":"Am\u00e9rique\/Martinique","contextid":228017};var yui1ConfigFn = function(me) {if(/-skin|reset|fonts|grids|base/.test(me.name)){me.type='css';me.path=me.path.replace(/\.js/,'.css');me.path=me.path.replace(/\/yui2-skin/,'/assets/skins/sam/yui2-skin')}};
...
<link rel="stylesheet" type="text/css" href="//fonts.googleapis.com/css?family=Open+Sans" />    <!-- CSS print media -->
    ...
    <meta name="twitter:title" value="L2S1 INF1 - UEO 31.1  TP - Algo &amp; Prog 3 [SEN 971]: TP4 : Fonctions" />

    <!-- Open Graph data -->
    <meta property="og:title" content="L2S1 INF1 - UEO 31.1  TP - Algo &amp; Prog 3 [SEN 971]: TP4 : Fonctions" />
...
<body  id="page-mod-resource-view" class="format-topics  path-mod path-mod-resource gecko dir-ltr lang-fr yui-skin-sam yui3-skin-sam ecursus-univ-antilles-fr pagelayout-incourse course-2600 context-228017 cmid-54829 category-1240 two-column  header-style1 has-region-side-post used-region-side-post side-post-only">
...
<div id="page" class="container-fluid fullin showblockicons">
    ...
    <a id="message-drawer-toggle-5de8488c28e6a5de8488c2109b27" class="nav-link d-inline-block popover-region-toggle position-relative" href="#"
            role="button">
    ...
    <div class="popover-region-toggle nav-link"
        ...
        role="button"
        aria-controls="popover-region-container-5de8488c2a0645de8488c2109b28"
        aria-haspopup="true"
    ...
    <div 
        id="popover-region-container-5de8488c2a0645de8488c2109b28"
    ...
    <div class="popover-region-toggle nav-link"
        data-region="popover-region-toggle"
        role="button"
        aria-controls="popover-region-container-5de8488c2ba715de8488c2109b29"
        aria-haspopup="true"
    ...
    <div 
        id="popover-region-container-5de8488c2ba715de8488c2109b29"
        class="popover-region-container"
        data-region="popover-region-container"
        aria-expanded="false"
        aria-hidden="true"
...
</div></div><li class="nav-item dropdown ml-3"><li class="nav-item dropdown"><a href="#" class="nav-link dropdown-toggle my-auto" id="langmenu0" aria-haspopup="true" data-target="#" data-toggle="dropdown" title="Langue"><i class="fa fa-globe fa-lg"></i><span class="langdesc">Français ‎(fr)‎</span></a><ul class="dropdown-menu" aria-labelledby="langmenu0"><li><a title="English ‎(en)‎" class="dropdown-item" href="https://ecursus.univ-antilles.fr/mod/resource/view.php?id=54829&amp;lang=en">English ‎(en)‎</a></li><li><a title="Español - Internacional ‎(es)‎" class="dropdown-item" href="https://ecursus.univ-antilles.fr/mod/resource/view.php?id=54829&amp;lang=es">Español - Internacional ‎(es)‎</a></li><li><a title="Français ‎(fr)‎" class="dropdown-item" href="https://ecursus.univ-antilles.fr/mod/resource/view.php?id=54829&amp;lang=fr">Français ‎(fr)‎</a></li></ul></li></li>
...
<div id="containerflex" style="width:100%;"> 
        <div class="row"><div id="page-navbar" class="col-12"><ul class="breadcrumb d-none d-md-flex"><li><a href="https://ecursus.univ-antilles.fr/"><i title="Accueil" class="fa fa-home fa-lg"></i></a></li><span class="separator"><i class="fa-angle-right fa"></i>
                             ...
                             </span><li><a href="https://ecursus.univ-antilles.fr/mod/resource/view.php?id=54829" id="label_10_33" class=""  tabindex="-1"  title="Fichier" >TP4 : Fonctions</a></li></ul></div></div>
           				<section id="region-main" style="width:100% !important; " class="col-md-9 custom">
			            <span class="notifications" id="user-notifications"></span><h2 class='headercoursetitle'>L2S1 INF1 - UEO 31.1  TP - Algo & Prog 3 [SEN 971]</h2><div role="main"><span id="maincontent"></span><h2>TP4 : Fonctions</h2><div id="resourceintro" class="box mod_introbox"><div class="no-overflow"><p>On désire pouvoir disposer d'un espace de stockage (tableau) de réels dont on ne connaît pas&nbsp;<span style="font-size: 0.9375rem;">la taille à l'avance.</span></p><p><span style="font-size: 0.9375rem;"><b>Travail à réaliser :</b></span></p><p><span style="font-size: 0.9375rem;"><span>Programmer et tester (dans l'ordre) les fonctions <i>ajoutfin, ajouttri, suppr, vider </i>et<i> menu</i> et les utiliser dans une fonction principale.</span></span></p></div><p class="resourcedetails">89.3Ko Document PDF</p></div><div class="resourceworkaround">Cliquer le lien <a href="https://ecursus.univ-antilles.fr/pluginfile.php/228017/mod_resource/content/2/TP4.pdf" onclick="window.open('https://ecursus.univ-antilles.fr/pluginfile.php/228017/mod_resource/content/2/TP4.pdf', '', 'width=620,height=450,toolbar=no,location=no,menubar=no,copyhistory=no,status=no,directories=no,scrollbars=yes,resizable=yes'); return false;">TP4.pdf</a> pour afficher le fichier.</div></div>        </section>
		</div>
...
>
    ...
    <div class="body-container position-relative" data-region="body-container">
        ...
        >
            ...
            <div class="d-flex flex-column h-100">
                <div class="p-3 border-bottom">
                    <ul class="nav nav-pills nav-fill" role="tablist">
                        <li class="nav-item">
                            <a
                                id="contacts-tab-5de8488c30abd5de8488c2109b33"
                                class="nav-link active"
                                href="#contacts-tab-panel-5de8488c30abd5de8488c2109b33"
                                data-toggle="tab"
                                data-action="show-contacts-section"
                                role="tab"
                                aria-controls="contacts-tab-panel-5de8488c30abd5de8488c2109b33"
                                aria-selected="true"
                            >
                                Contacts
                            </a>
                        ...
                        <li class="nav-item">
                            <a
                                id="requests-tab-5de8488c30abd5de8488c2109b33"
                                class="nav-link"
                                href="#requests-tab-panel-5de8488c30abd5de8488c2109b33"
                                data-toggle="tab"
                                data-action="show-requests-section"
                                role="tab"
                                aria-controls="requests-tab-panel-5de8488c30abd5de8488c2109b33"
                                aria-selected="false"
                            >
                                Demandes
                                <span class="badge bg-primary ml-2 hidden"
            ...
            data-user-id="29109"
                                id="contacts-tab-panel-5de8488c30abd5de8488c2109b33"
                    data-section="contacts"
                    role="tabpanel"
                    aria-labelledby="contacts-tab-5de8488c30abd5de8488c2109b33"
        ...
        >
            ...
            data-region="lazy-load-list"
            data-user-id="29109"
                                id="requests-tab-panel-5de8488c30abd5de8488c2109b33"
                    data-section="requests"
                    role="tabpanel"
                    aria-labelledby="requests-tab-5de8488c30abd5de8488c2109b33"
            ...
            <div class="hidden" data-region="content-container">
                ...
                <div data-region="settings" class="p-3">
                    ...
                    <div data-preference="blocknoncontacts" class="mb-3">
                            <div class="custom-control custom-radio mb-2">
                                <input
                                    ...
                                    id="block-noncontacts-5de8488c30abd5de8488c2109b33-1"
                                    value="1"
                                >
                                <label class="custom-control-label ml-2" for="block-noncontacts-5de8488c30abd5de8488c2109b33-1">
                            ...
                            <div class="custom-control custom-radio mb-2">
                                <input
                                    ...
                                    name="message_blocknoncontacts"
                                    class="custom-control-input"
                                    id="block-noncontacts-5de8488c30abd5de8488c2109b33-0"
                                    value="0"
                                >
                                <label class="custom-control-label ml-2" for="block-noncontacts-5de8488c30abd5de8488c2109b33-0">
                    ...
                    <div data-preference="entertosend">
                        <span class="switch">
                            <input type="checkbox"
                                id="enter-to-send-5de8488c30abd5de8488c2109b33"
                                
                            >
                            <label for="enter-to-send-5de8488c30abd5de8488c2109b33">
    ...
    <div class="info container2 clearfix">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 my-md-0 my-2">
                    <div class="tool_dataprivacy"><a href="https://ecursus.univ-antilles.fr/admin/tool/dataprivacy/summary.php">Résumé de conservation de données</a></div><a href="https://download.moodle.org/mobile?version=2018120305.02&amp;lang=fr&amp;iosappid=633359593&amp;androidappid=com.moodle.moodlemobile">Obtenir l'app mobile</a><div class="performanceinfo pageinfo">Informations sur cette page : General type: incourse. Context Fichier: TP4 : Fonctions (context id 228017). Page type mod-resource-view. </div>                </div>
            </div>
        </div>
    </div>
</footer>
...
function(
    ...
    var toggle = $('#message-drawer-toggle-5de8488c28e6a5de8488c2109b27');
    Popover.init(toggle);
});
;
...
require(['jquery', 'core_message/message_drawer'], function($, MessageDrawer) {
    var root = $('#message-drawer-5de8488c30abd5de8488c2109b33');
...
M.util.init_block_hider(Y, {"id":"inst5","title":"Administration","preference":"block5hidden","tooltipVisible":"Cacher le bloc Administration","tooltipHidden":"Montrer le bloc Administration"});
 M.util.js_pending('random5de8488c2109b34'); Y.on('domready', function() { M.util.js_complete("init");  M.util.js_complete('random5de8488c2109b34'); });
})();
//]]>
</script>
